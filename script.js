...
function createGift() {
  ...
  const messages = [
    '🌸 Hương Giang ơi, chúc bạn một năm mới đầy niềm vui và hạnh phúc!',
    '🎁 Chúc Hương Giang luôn xinh đẹp, mạnh khỏe và luôn tươi cười mỗi ngày!',
    '🌟 Hương Giang, hy vọng năm mới sẽ mang đến cho bạn những cơ hội tuyệt vời và thành công rực rỡ!',
    '💐 Hương Giang, chúc bạn mỗi ngày đều tràn đầy niềm vui và tình yêu thương!',
    '🎉 Hương Giang ơi, chúc bạn luôn may mắn, bình an và đạt được mọi ước mơ trong năm mới!',
    '🌷 Chúc Hương Giang luôn được yêu thương và thành công trong mọi công việc và cuộc sống!',
    '🎄 Hương Giang, một năm mới an lành, ngập tràn hạnh phúc và những điều tốt đẹp sẽ đến với Giang!',
    '🎶 Chúc Hương Giang có một mùa Giáng sinh ấm áp bên những người thân yêu và đầy niềm vui!'
  ];
